...
export default function CommonActivityDetail() {
  ...
  if (isError || !ca) {
    return <div className="page"><p>Common activity not found.</p></div>;
  }
  ...
  return (
    <div className="page">
      ...
      <h3 className="section-title">Activities on this route</h3>
      {activities.length === 0 ? (
        <p style={{ color: "var(--text-muted)" }}>
          No activities yet. Log one with a similar route to see it appear here.
        </p>
      ) : (
